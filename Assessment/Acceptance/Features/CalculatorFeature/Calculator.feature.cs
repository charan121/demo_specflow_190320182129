...
namespace Assessment.Acceptance.Features.CalculatorFeature
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Calculator", Description="\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the sum o" +
        "f two numbers", SourceFile="Acceptance\\Features\\CalculatorFeature\\Calculator.feature", SourceLine=0)]
